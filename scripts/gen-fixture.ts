  ...
  gens: [
    {
      ...
      card: {
        ...
        surface: 'middleware' as const, surfaceReason: 'Guarded intercept at the commit boundary (PRISM middleware surface)',
      },
    ...
    },
    {
      ...
      card: {
        ...
        surface: 'middleware' as const, surfaceReason: 'Runtime compaction mechanism, not prompt wording (PRISM middleware surface)',
      },
    ...
    },
    {
      ...
      card: {
        ...
        surface: 'prompt' as const, surfaceReason: 'Guideline text the model reads before acting (PRISM prompt surface)',
      },
    ...
    },
    {
      ...
      card: {
        ...
        surface: 'middleware' as const, surfaceReason: 'PostToolUse hook truncates tool output outside the model (PRISM middleware surface)',
      },
    ...
    },
    {
      ...
      card: {
        ...
        surface: 'joint' as const, surfaceReason: 'Hook enforces a prompt-level evidence convention (PRISM joint surface)',
      },
    ...
    },
    {
      ...
      card: {
        ...
        surface: 'prompt' as const, surfaceReason: 'Fixed self-reflection rule expressed as loop instruction (PRISM prompt surface)'
      },
    ...
    },
    {
      ...
      card: {
        ...
        surface: 'middleware' as const, surfaceReason: 'Join-time verification between runtime and logs (PRISM middleware surface)'
      },
    ...
    },
    {
      ...
      card: {
        ...
        surface: 'middleware' as const, surfaceReason: 'State externalized to path-addressable files (PRISM middleware surface)'
      },
    ...
    },
    {
      ...
      card: {
        ...
        surface: 'joint' as const, surfaceReason: 'Eval snapshot plus loop instruction to diff before commit (PRISM joint surface)'
      },
